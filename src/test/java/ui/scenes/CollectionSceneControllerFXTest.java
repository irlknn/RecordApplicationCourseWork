...
public class CollectionSceneControllerFXTest extends ApplicationTest {
    ...
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/CollectionScene.fxml"));
    ...
    void testClickSearchButton() {
        // Введення значення в текстове поле
        clickOn("#enterField").write("test");
        // Вибір параметру з ChoiceBox
        clickOn("#findChoiceBox").clickOn("title");
        // Натискання кнопки пошуку
        clickOn("#searchButton");

        // Тут можна перевірити, чи було викликано findBy, якщо його також mock-ати
        // або вивести зміст таблиці
    }

    @Test
    void testClickDeleteButtonWithoutSelection() {
        // Без вибору жодного елементу delete не повинен кидати виключення
        clickOn("#deleteButton");
        // Перевірка, що deleteFromTableById не викликано:
    ...
    void testExitButton() {
        clickOn("#exitButton");
        // Очікується повернення до головної сцени (SceneController можна mock-ати)
    }
}
...
//
//        // Debugging line:
//        java.net.URL fxmlLocation = getClass().getResource("/ui/scenes/CollectionScene.fxml");
//        if (fxmlLocation == null) {
//            System.err.println("ERROR: FXML file not found! Check path: /ui/scenes/CollectionScene.fxml");
